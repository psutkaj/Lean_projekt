...
1. Počkejte na dokončení instalace (cca 5 minut).
2. Otevřete soubor ve složce `LEANprj/`.
3. Sledujte panel **Lean Infoview** vpravo – zobrazuje živý stav důkazu pro každý řádek kódu.
